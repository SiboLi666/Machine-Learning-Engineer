...
# **Answer**:
# Cropping is used to resize the image. I chose the size 256 because it is commonly used in image uint8 format and is good to start with. I decided to augment the dataset by flipping and rotations.
...
# __Answer:__
# The structure is listed above. I used three CNN layers to generalize the images and extract the feature. Then I used linear classifier to convert the abstract features to the classified type and the dropout layer to overcome overfitting.
...
# __Answer:__ 
# Resnet50 is a CNN classsfier similar to the VGG16. It was found that Resnet50 worked fine.
...
# __Answer:__ Yes. The improvement points can be 1) increase the number of training dataset; 2) Fine tune the model to give a better accuracy; 3) return the highly possible estimations of the breeds and keep them for later training stages.
